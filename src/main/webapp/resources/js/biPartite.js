!function(){
	...
	var bP={};	
	var b=30, bb=150;/*, height =1250; }*/
	var buffMargin=1, minHeight=5;
	//var c1=[-110, 40], c2=[-50, 100], c3=[-10, 140]; //Column positions of labels.
	var c1=[-240, 40], c2=[-50, 260], c3=[-10, 300];/**c1[a,b]=primeiro label (a-dir b-esq) c2[a,b]=segundo label (a-dir b-esq) c3=porcent*/
	//var colors =["#3366CC", "#DC3912",  "#FF9900","#109618", "#990099", "#0099C6", "#ff5555"," #ffd700"];
	
	var red = new Array("00","33","66","99","CC","FF");
	var green = new Array("11","33","66","99","CC","FF");
	...
	for (i=0;i<red.length;i++) {
	    for (j=0;j<green.length;j++) {
	       for (k=0;k<blue.length;k++) {
	          //combina as componentes para formar a cor
	          var nova_cor = "#" + red[i] + green[j] + blue[k];
	          colors.push(nova_cor);
	       }
	    }
	} 
	...
	function drawHeader(header, id){
		...
		[0,1].forEach(function(d){
			...
			h.append("text").text("Quantidade").attr("x", (c2[d]-10))
				.attr("y", -5).style("fill","grey");
